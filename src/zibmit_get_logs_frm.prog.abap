...
FORM f_start_process.
  ...
  lcl_cds_col->add_ranges_for_name( iv_name = 'LOGSTART'  it_ranges = s_lgstat[] ).
  lcl_cds_col->add_ranges_for_name( iv_name = 'LOGEND'    it_ranges = s_lgend[] ).
  lcl_cds_col->add_ranges_for_name( iv_name = 'NAME'      it_ranges = s_name[] ).
  lcl_cds_col->add_ranges_for_name( iv_name = 'STATUS'    it_ranges = s_status[] ).
